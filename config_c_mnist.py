...
# For data
parser.add_option('--dn', '--data_name', dest='data_name', default='c_mnist',
                  help='mnist, fashion_mnist, t_mnist, c_mnist, cub (default: mnist)')

parser.add_option('--ih', '--img_h', dest='img_h', default=60, type='int',
                  help='input image height (default: 28)')
parser.add_option('--iw', '--img_w', dest='img_w', default=60, type='int',
...
parser.add_option('--lp', '--load_model_path', dest='load_model_path',
                  default='/home/cougarnet.uh.edu/amobiny/Desktop/capsule_network_pytorch/save/20191023_115602/models/86400.ckpt',
